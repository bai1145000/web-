...
from goods.models import GoodType,IndexActivity,IndexGoodBanner,IndexTypeGoodsBanner,GoodsSKU
...
class IndexView(View):
    ...
    def get(self, request):
        ...
        if context is None:
            ...
            # 获取首页促销活动信息
            promotion_banners = IndexActivity.objects.all().order_by('index')
...
class ListView(View):
    ...
    def get(self,request,type_id,page):
        ...
        if sort == 'host':
            ...
            skus = GoodsSKU.objects.filter(type=type).order_by('default ')
